/* linkedlists-double.c - this program demonstrates doubly linked lists.
...
/* This is a monster structure for a doubly linked list of monsters.  It contains
   basic information about a monster, as well as a link to a next monster and a
   previous monster.
   
   next is null if and only if one of the following things is true:

    * The monster has not been added to a list yet
    * The monster sits at the tail of the list 
    
   prev is null if and only if one of the following things is true:

    * The monster has not been added to a list yet
    * The monster sits at the head of the list
